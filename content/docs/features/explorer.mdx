...
Right-click a file -> **Attach to AI** to add it to the [composer](/docs/ai/composer) as an attachment. Or select text in any tab and use `Cmd+J` (Ask AI about selection) to attach the selection as a `<selection source="...">` block on submit.
